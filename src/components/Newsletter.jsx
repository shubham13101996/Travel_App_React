...
const Newsletter = () => {
  return (
    <>
      <div
        className="p-5 bg-white/60 ring-1 ring-emerald-200 shadow-md
       shadow-emerald-300 rounded-lg w-full max-w-5xl ml-auto mr-auto mt-0 
       xl:w-[95vw] relative top-12"
      >
        <div className="flex items-center justify-between lg:flex-col lg:gap-7 ">
          <div className=" grid items-center sm:text-center ">
            <h1 className="text-4xl md:text-3xl sm:text-2xl filter drop-shadow-lg text-slate-900 font-bold">
            ...
            <p
             ...
             font-medium"
            >
              Question and Feedback? We would like to hear from you.{" "}
            </p>
          </div>
          <form className="flex items-center justify-center relative">
            <input
              type={"email"}
              className="py-2 px-5 ring-1 ring-sla300 flex items-center 
              shadow-md shadow-slate-200 w-96 lg:w-[85vw] text-base rounded-full 
